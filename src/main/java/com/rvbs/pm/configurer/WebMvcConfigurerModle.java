...
@Slf4j
@Configuration
public class WebMvcConfigurerModle implements WebMvcConfigurer {
//public class WebMvcConfigurerModle extends WebMvcConfigurationSupport {

    private final Logger logger = LoggerFactory.getLogger(WebMvcConfigurerModle.class);
...
//        .allowedMethods("GET", "HEAD", "POST", "PUT", "DELETE", "OPTIONS")
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	logger.info("注册拦截器");
    	registry.addInterceptor(new PMHandAdapter()).excludePathPatterns("/user/login","/user/usercheck");
    }
    @Bean
