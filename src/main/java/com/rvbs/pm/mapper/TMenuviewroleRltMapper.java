...
public interface TMenuviewroleRltMapper extends BaseDefaultMapper<TMenuviewroleRlt> {
	...
	@Select("select t.ROLEID,t.MENUVIEWNUM,t.ENABLEFLAG,i.MENUVIEWNAME,i.MENUNAME,i.MENUNUM,i.PARENTMENUNUM,i.ISVISIBLE from t_menuview_info i,t_menuviewrole_rlt t where i.MENUVIEWNUM=t.MENUVIEWNUM ")
